...
---
Example 1: search is needed, only search once
Question: xxx?
...
You can search 0 - 3 times. 0 is preferable. Each search should be foucsed on one sub-question/entity.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='./data/2wikimultihopqa_knowledge_boundary')
    ...
    dataset = datasets.load_dataset('RUC-NLPIR/FlashRAG_datasets', '2wikimultihopqa')
