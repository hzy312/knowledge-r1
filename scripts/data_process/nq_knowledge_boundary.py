...
To arrive at the answer, you will proceed step-by-step in a structured cycle of '<think>thinking content</think>', '<search>search query</search>' (optional), and '<information>returned external information</information>' (optional) sequences. You can only generate content within these special tags.
...
Thinking Phase (<think>): Recall your own knowledge, analyze current information, and decide whether further search is needed. If enough knowledge is available, skip searching.
...
---
Example 2: search is not needed
Question: xxx?
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='./data/hotpotqa_knowledge_boundary')
            ...
            if split == 'train':
                data = {
                    ...
                    "extra_info": {
                        'split': split,
                        'index': idx,
                        'know_or_unknow': example['know_or_unknow']
                    }
                }
            elif split == 'test':
                data = {
