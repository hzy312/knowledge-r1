...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='./data/nq_hotpotqa_knowledge_boundary_easy')
    ...
    nq_train = nq_easy_dataset['train']
    ...
    hotpotqa_train = hotpotqa_easy_dataset['train']
