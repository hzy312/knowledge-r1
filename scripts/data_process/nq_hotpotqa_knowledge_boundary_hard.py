...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='./data/nq_hotpotqa_knowledge_boundary_hard')
    ...
    nq_train = nq_hard_dataset['train']
    # nq_test = nq_hard_dataset['test']
    ...
    hotpotqa_train = hotpotqa_hard_dataset['train']
    # hotpotqa_test = hotpotqa_hard_dataset['test']
